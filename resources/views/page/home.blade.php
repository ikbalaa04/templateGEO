                        ...
                        <div class="col-lg-10">
                            <div class="nk-frame" data-aos="fade-up" data-aos-delay="500">
                                ...
                                <div class="nk-frame-children nk-frame-children-two">
                                    <img src="assets/images/codebase/banner-cover-1-b.png" alt="banner-cover-a" class="animate animate-shakeY animate-duration-12 animate-delay-1">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row gy-2 gap-sm-2 justify-content-center text-center align-items-center">
                            <div class="col-4 col-sm-3 col-lg-2">
                                <div class="nk-brand" data-aos="fade-up" data-aos-delay="50">
                                    <img src="assets/images/brands/a.png" alt="" class="opacity-75">
                                </div>
                            </div>
                            <div class="col-4 col-sm-3 col-lg-2">
                                <div class="nk-brand" data-aos="fade-up" data-aos-delay="100">
                                    <img src="assets/images/brands/b.png" alt="" class="opacity-75">
                                </div>
                            </div>
                            <div class="col-4 col-sm-3 col-lg-2">
                                <div class="nk-brand" data-aos="fade-up" data-aos-delay="150">
                                    <img src="assets/images/brands/c.png" alt="" class="opacity-75">
                                </div>
                            </div>
                            <div class="col-4 col-sm-3 col-lg-2">
                                <div class="nk-brand" data-aos="fade-up" data-aos-delay="200">
                                    <img src="assets/images/brands/d.png" alt="" class="opacity-75">
                                </div>
                            </div>
                            <div class="col-4 col-sm-3 col-lg-2">
                                <div class="nk-brand" data-aos="fade-up" data-aos-delay="250">
                                    <img src="assets/images/brands/e.png" alt="" class="opacity-75">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                        <div class="nk-frame nk-frame-16 mb-5 mb-sm-7 mb-lg-0">
                            ...
                            <div class="nk-frame-children nk-frame-children-one d-none d-md-block">
                                <img src="assets/images/codebase/section-cover-2-a.png" alt="section-cover" data-aos="fade-up" data-aos-delay="100">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-5">
                        <div>
                            <h2 class="pb-5 pb-lg-7 text-capitalize"> Codely works and refresh the code in real time for everyone</h2>
                            <ul class="d-flex flex-column gap-5">
                                <li class="d-flex gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="fs-16 text-gray-800"> Aliquam vestibulum morbi blandit cursus risus atomol ultrices proin gravida hendrerit lectusa. </p>
                                    </div>
                                </li>
                                <li class="d-flex gap-3">
                                    <div class="media media-lg media-middle media-circle text-bg-dark mb-4">
